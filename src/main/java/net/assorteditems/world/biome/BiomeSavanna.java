...
public class BiomeSavanna extends ElementsAssortedItemsMod.ModElement {
	@GameRegistry.ObjectHolder("assorted_items:savanna")
	public static final BiomeGenCustom biome = null;
	public BiomeSavanna(ElementsAssortedItemsMod instance) {
		super(instance, 341);
	}
	...
	public void init(FMLInitializationEvent event) {
		...
		BiomeManager.addBiome(BiomeManager.BiomeType.DESERT, new BiomeManager.BiomeEntry(biome, 8));
	}
	static class BiomeGenCustom extends Biome {
		public BiomeGenCustom() {
			super(new Biome.BiomeProperties("savanna").setRainfall(0.2F).setBaseHeight(0.1F).setHeightVariation(0.2F).setTemperature(1F));
			setRegistryName("savanna");
			...
			this.spawnableCreatureList.add(new SpawnListEntry(EntityAgeable.class, 14, 2, 4));
		}
	...
	static class CustomTree extends WorldGenAbstractTree {
		...
		public boolean generate(World world, Random rand, BlockPos position) {
			...
			if (position.getY() >= 1 && position.getY() + height + 1 <= world.getHeight()) {
				...
				if (!spawnTree) {
					...
					if (!((ground == Blocks.SAND.getStateFromMeta(0).getBlock() || ground == Blocks.STONE.getStateFromMeta(0).getBlock())
							&& (ground2 == Blocks.SAND.getStateFromMeta(0).getBlock() || ground2 == Blocks.STONE.getStateFromMeta(0).getBlock())))
						return false;
					...
					if (position.getY() < world.getHeight() - height - 1) {
								...
								for (int i2 = position.getZ() - j1; i2 <= position.getZ() + j1; ++i2) {
									...
									if (Math.abs(position.getX()) != j1 || Math.abs(j2) != j1 || rand.nextInt(2) != 0 && i4 != 0) {
										...
										if (state.getBlock().isAir(state, world, blockpos) || state.getBlock().isLeaves(state, world, blockpos)
												...
												|| state.getBlock() == Blocks.LOG.getStateFromMeta(2).getBlock()) {
											this.setBlockAndNotifyAdequately(world, blockpos, Blocks.LOG.getStateFromMeta(2));
										}
									}
								}
							}
						...
						for (int genh = 0; genh < height; genh++) {
							...
							if (state.getBlock().isAir(state, world, genhPos) || state.getBlock() == Blocks.AIR.getDefaultState().getBlock()
									|| state.getBlock() == Blocks.LOG.getStateFromMeta(2).getBlock()) {
								this.setBlockAndNotifyAdequately(world, position.up(genh), Blocks.LOG.getStateFromMeta(2));
							}
						}
		...
		protected boolean canGrowInto(Block blockType) {
			return blockType.getDefaultState().getMaterial() == Material.AIR || blockType == Blocks.LOG.getStateFromMeta(2).getBlock()
					|| blockType == Blocks.LOG.getStateFromMeta(2).getBlock() || blockType == Blocks.SAND.getStateFromMeta(0).getBlock()
